...
const port = "";
const algodClient = new algosdk.Algodv2(tokenID, host, port);

const address_1 = "TPWLWQUEQTWJTJF2ROWZX77BXPVXWCB6623T7SNLXOV7ZIWLAISHD2U6DE";
const address_2 = "77L5JXCEOYJX6573EIUOHC2ITXIDLNNWQGMS46OCQBGT6C6Y5TOWMNFYWI";

const indexerClient = new algosdk.Indexer(tokenID, "https://testnet-algorand.api.purestake.io/idx2", port);
